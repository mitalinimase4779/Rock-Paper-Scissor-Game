...
# For changing the name of title
...
# insert picture
# label the pictures in tkinter
user_label = Label(root, image=scissor_img, bg="#9b59b6")
comp_label = Label(root, image=scissor_img_comp, bg="#9b59b6")

# Place these labels in our window
# here i used grid method for placing these labels
...
# mainloop method will run whenever our application is ready to start
root.mainloop()
